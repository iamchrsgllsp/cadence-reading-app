...
from application.logic import fetch_data_from_api, process_data, get_book_details_from_openlibrary
from application.database import amend_top_five, add_book_to_library, remove_from_library, update_currentbook
import json
import ast
...
def add_top_five():
    amend_top_five("raidy",[[1, "The Knight and The Moth"],
    [2, "Twisted Window"],
    [3, "Between Two Fires"],
    [4, "Silver Nitrate"],
