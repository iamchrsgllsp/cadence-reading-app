...
sid = "815d5f1a86de4e46a5f87914f76dba2e"
sid_sec = "ea85e06d40374c789ccec0fe7e0bef28"
...
def create_playlist(book, songs):
    ...
    track_uris = [f"spotify:track:{track['spotify_id']}" for track in track_uris if 'spotify_id' in track]
